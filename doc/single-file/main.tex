...
\chapter{Wstęp}
\label{ch:wstep}
Celem niniejszego rozdziału jest wprowadzenie do tematyki pracy inżynierskiej, 
przedstawienie motywacji podjęcia tematu oraz zarysowanie problemu, którego 
...
Celem niniejszego rozdziału jest określenie wymagań funkcjonalnych i 
niefunkcjonalnych projektowanego systemu oraz przedstawienie technologii i 
narzędzi wykorzystanych podczas realizacji pracy. Zdefiniowane wymagania 
...
zaprojektowanego systemu. Omówiono strukturę aplikacji, podział na warstwy, 
...
Sekcja ta skupia się na szczegółowej analizie projektu architektury schematu, przedstawiając schemat ideowy, analizując każdy z modułów aplikacji.
...
\begin{enumerate}
    ...
    wchodzących w skład zamówienia oraz ich ilościach, umożliwiając poprawne
...
aplikacji oraz ocena stopnia spełnienia założonych wymagań funkcjonalnych.
