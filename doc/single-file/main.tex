...
Sekcja ta skupia się na szczegółowej analizie projektu architektury schematu, przedstawiając schemat ideowy oraz analizując każdy z modułów systemu.
\subsection{Schemat ideowy}
Na rysunku przedstawiono schemat ideowy działania systemu teleinforamtycznego, każdy z komponentów przedstawiony na schemacie został szczegółowo opisany w rodziałach (napisac jakie numery odwolac sie)
\begin{figure}[H]
    \centering
